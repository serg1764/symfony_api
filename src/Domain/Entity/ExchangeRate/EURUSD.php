...
/**
 * Сущность для хранения истории курса EUR/USD
 */
#[ORM\Entity]
#[ORM\Table(name: 'exchange_rate_eur_usd')]
#[ORM\Index(columns: ['timestamp'], name: 'idx_eur_usd_timestamp')]
class EURUSD extends ExchangeRateRecord
{
